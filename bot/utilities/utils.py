...
def darken_colour(red: float, green: float, blue: float, factor: float = 0.1) -> tuple[int, int, int]:
...
def lighten_colour(red: float, green: float, blue: float, factor: float = 0.1) -> tuple[int, int, int]:
