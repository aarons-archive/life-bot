...
class Reminders(commands.Cog):
    ...
    async def _reminders(self, ctx: custom.Context) -> None:
        """
    ...
    async def _reminders_list(self, ctx: custom.Context) -> None:
        """
    ...
    async def _reminders_all(self, ctx: custom.Context) -> None:
        """
    ...
    async def _reminders_edit(self, ctx: custom.Context, reminder: objects.Reminder, *, content: str) -> None:
        """
    ...
    async def _reminders_info(self, ctx: custom.Context, reminder: objects.Reminder) -> None:
        """
