...
class Time(commands.Cog):
    ...
    async def times(self, ctx: custom.Context) -> None:
        """
    ...
    async def timezones(self, ctx: custom.Context) -> None:
        """
    ...
    async def _timezone(self, ctx: custom.Context, *, timezone: Optional[str]) -> None:
        """
    ...
    async def _timezone_set(self, ctx: custom.Context, *, timezone: Timezone) -> None:
        """
        Sets your timezone.
    ...
    async def _timezone_private(self, ctx: custom.Context) -> None:
        """
    ...
    async def _timezone_public(self, ctx: custom.Context) -> None:
        """
