...
class Birthdays(commands.Cog):
    ...
    async def _birthday(self, ctx: custom.Context, *, person: discord.Member = utils.MISSING) -> None:
        """
    ...
    async def _birthday_private(self, ctx: custom.Context) -> None:
        """
    ...
    async def _birthday_public(self, ctx: custom.Context) -> None:
        """
    ...
    async def _birthday_list(self, ctx: custom.Context) -> None:
        """
    ...
    async def _birthday_next(self, ctx: custom.Context) -> None:
        """
    ...
    async def _birthday_card(self, ctx: custom.Context) -> None:
        """
    ...
    async def _birthdays(self, ctx: custom.Context) -> None:
        """
        Displays a list of upcoming birthdays in the current server.
        """
