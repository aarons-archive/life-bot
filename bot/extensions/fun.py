...
class Fun(commands.Cog):
    ...
    async def rps(self, ctx: custom.Context) -> None:
        """
    ...
    async def magic_8_ball(self, ctx: custom.Context, *, question: str | None) -> None:
        """
    ...
    async def rate(self, ctx: custom.Context, *, person: discord.User = utils.MISSING) -> None:
        """
    ...
    async def gay_rate(self, ctx: custom.Context, *, person: discord.User = utils.MISSING) -> None:
        """
    ...
    async def iq_rate(self, ctx: custom.Context, *, person: discord.User = utils.MISSING) -> None:
        """
    ...
    async def choose(self, ctx: custom.Context, *choices: commands.clean_content) -> None:
        """
    ...
    async def choosebestof(self, ctx: custom.Context, times: Optional[int], *choices: commands.clean_content) -> None:
        """
