...
class Tags(commands.Cog):
    ...
    async def tag(self, ctx: context.Context[Life], *, name: converters.TagNameConverter) -> None:
        """
        Gets a tag.
    ...
    async def tag_raw(self, ctx: context.Context[Life], *, name: converters.TagNameConverter) -> None:
        """
    ...
    async def tag_create(self, ctx: context.Context[Life], name: converters.TagNameConverter, *, content: converters.TagContentConverter) -> None:
        """
        Creates a tag.
    ...
    async def tag_alias(self, ctx: context.Context[Life], alias: converters.TagNameConverter, original: converters.TagNameConverter) -> None:
        """
    ...
    async def tag_claim(self, ctx: context.Context[Life], *, name: converters.TagNameConverter) -> None:
        """
    ...
    async def tag_transfer(self, ctx: context.Context[Life], name: converters.TagNameConverter, *, member: discord.Member) -> None:
        """
    ...
    async def tag_edit(self, ctx: context.Context[Life], name: converters.TagNameConverter, *, content: converters.TagContentConverter) -> None:
        """
    ...
    async def tag_delete(self, ctx: context.Context[Life], *, name: converters.TagNameConverter) -> None:
        """
        Deletes a tag.
    ...
    async def tag_search(self, ctx: context.Context[Life], *, name: converters.TagNameConverter) -> None:
        """
    ...
    async def tag_list(self, ctx: context.Context[Life], *, person: discord.Member = utils.MISSING) -> None:
        """
    ...
    async def tag_all(self, ctx: context.Context[Life]) -> None:
        """
    ...
    async def tag_info(self, ctx: context.Context[Life], *, name: converters.TagNameConverter) -> None:
        """
