...
class Economy(commands.Cog):
    ...
    async def level(self, ctx: context.Context[Life], person: converters.PersonConverter = utils.MISSING) -> None:
        """
    ...
    async def leaderboard(self, ctx: context.Context[Life]) -> None:
        """
    ...
    async def leaderboard_text(self, ctx: context.Context[Life]) -> None:
        """
