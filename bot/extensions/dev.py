...
class Dev(commands.Cog):
    ...
    async def dev(self, ctx: custom.Context) -> None:
        """
    ...
    async def dev_guilds(self, ctx: custom.Context) -> None:
        """
    ...
    async def dev_socket_stats(self, ctx: custom.Context) -> None:
        """
    ...
    async def blacklist(self, ctx: custom.Context) -> None:
        """
